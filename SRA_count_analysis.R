...
og <- read.table("../alignments/SRP040525_sa_alignments_genome_list.txt", header = FALSE, stringsAsFactors = FALSE) #keep only reads found on the genome
rRNA <- read.table("../alignments/biogenesis_SRP040525/SRP040525_sa_alignments_rRNA_list.txt", header = FALSE, stringsAsFactors = FALSE) #remove rRNA reads
YRNA <- read.table("../alignments/biogenesis_SRP040525/SRP040525_sa_alignments_YRNA_list.txt", header = FALSE, stringsAsFactors = FALSE) #remove YRNA reads
...
pie$Stem <- rowMeans(read_counts[,c(2,3,9,10)])
pie$Diff <- rowMeans(read_counts[,c(4,5,6,7,9,10,11,12)])
